...
<p class="mb-5 mt-5"><span style="font-size: 30px;">Öğrenciler (En çok soru soran)</span></p>  

<table class="table table-striped table-light">
<p style="text-align: right; width: 1400px; margin: 0px auto 20px auto;">Değiştir: <a href="ogrenciler-cevap.php">En çok cevap veren</a> - <a href="ogrenciler-onaylanancevap.php">En çok onaylanan cevabı veren</a></p>
<thead>
    <tr>
      <th scope="col">#</th>
  ...
  <tbody>
    ...
    <?php
        ...
        $sql = "SELECT * FROM uyeler ORDER BY toplamsoru DESC LIMIT $offset, $no_of_records_per_page";
