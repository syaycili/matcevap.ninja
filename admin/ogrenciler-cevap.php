...
<p class="mb-5 mt-5"><span style="font-size: 30px;">Öğrenciler (En çok cevap veren)</span></p>  
...
<thead>
  ...
  <tbody>
    ...
    <?php
        ...
        $sql = "SELECT * FROM uyeler ORDER BY tumcevap DESC LIMIT $offset, $no_of_records_per_page";
